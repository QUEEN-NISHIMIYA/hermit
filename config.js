...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'riyah;izumie;918593848438;https://i.imgur.com/HdugYIv.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'izumie;918593848438;https://i.imgur.com/HdugYIv.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '💖izumie💖;918593848438' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '918593848438,919961450351',
       DEBUG: DEBUG
};
